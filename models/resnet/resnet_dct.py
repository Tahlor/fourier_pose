...
import torch
import numpy as np
from models.resnet.utils import *
...
class ResNetDCT_Upscaled_Static(nn.Module):
    def __init__(self, channels=0, pretrained=True, input_gate=False, num_classes = 1000):
        ...
        self.model = nn.Sequential(*list(model.children())[4:-3])
        self.fc1 = list(model.children())[-3]
        #print("1")
        #print(self.fc1)
        self.fc2 = list(model.children())[-2]
        #print("2")
        #print(self.fc2)
        self.fc = list(model.children())[-1]
        #print("3")
